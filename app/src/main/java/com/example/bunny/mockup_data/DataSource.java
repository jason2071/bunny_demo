...
public class DataSource {
    ...
    public static int[] writeCancelInt() {
        return new int[]{
                0x10, 0x02, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00
                , 0x00, 0x08, 0x00, 0x01, 0x00, 0x01, 0x00, 0xaa
                , 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x04
                , 0x00, 0x00, 0x00, 0x00, 0x00, 0xd8, 0xc1, 0x10
                , 0x03
        };
    }

    public static byte[] checkBalance() {
        return new byte[]{
